...
d_full = d_full %>%
  dplyr::mutate(avdeling_navn = dplyr::case_when(emp11_department == 4 ~  "Medisinsk p1 Nord",
                                   #Her begynner Helse Bergen
                                   ...
                                   emp11_department == 19 ~ "Urologi",  
                                   emp11_department == 20 ~ "Øre, nese, hals",
                                   ...
                                   emp11_department == 25 ~ "Nevrologisk p3", 
                                   emp11_department == 26 ~ "Nevrologisk p4\nSpinal", 
                                   emp11_department == 27 ~ "Nevrologisk p2\nSlag",
                                   ...
                                   emp11_department == 43 ~ "ØNH barnekirurgen p1",  
                                   emp11_department == 44 ~ "AFMR p2",
                                   emp11_department == 77 ~ "Medisinsk avd.8",
                                   emp11_department == 85 ~ "Øyeavdeling", 
                                   emp11_department == 40 ~ "Øyeavdeling",
                                   ...
                                   emp11_department == 155 ~ "KSK Postoperativ", #Her slutter Helse Bergen
                                   ...
                                   emp11_department == 107 ~ "Kirurgisk tung overvåking",
                                   ...
                                   emp11_department == 113 ~ "Sengepost fordøyelse- og leversykdommer",
                                   ...
                                   emp11_department == 124 ~ "Lungemedisin 6. et. overvåking",
                                   ...
                                   emp11_department == 131 ~ "ØNH sengepost",
                                   emp11_department == 132 ~ "Øye sengepost",                                           
                                   emp11_department == 133 ~ "Nevrologisk sengepost",
                                   emp11_department == 134 ~ "Nevrokirurgisk sengepost",
                                   emp11_department == 135 ~ "Nevroklinikkens overvåking",
                                   ...
                                   emp11_department == 145 ~ "Ortopedisk postoperativ overvåking",
                                   ...
                                   emp11_department == 150 ~ "Avdeling Østmarka",
                                   emp11_department == 151 ~ "Avdeling Brøset",                #Her slutter St. Olavs
                                   emp11_department == 45 ~ "Akuttmottak- og obspostavdeling", #Her begynner UNN
                                   emp11_department == 46 ~ "Barne- og ungdomsavdeling",
                                   emp11_department == 47 ~ "Barnehabilitering Tromsø",
                                   ...
                                   emp11_department == 61 ~ "Nevrokirurgi-, ØNH- og øyeavdeling",
                                   emp11_department == 62 ~ "Ortopedi- og plastikkirurgisk avdeling",
                                   emp11_department == 63 ~ "Fysikalsk- og rehabiliteringsmedisin, Tromsø/Narvik",
                                   emp11_department == 64 ~ "Habiliteringsenhet Tromsø",
                                   emp11_department == 65 ~ "Intensiv Tromsø",
                                   emp11_department == 66 ~ "Oppvåkning Tromsø",
                                   ...
                                   emp11_department == 73 ~ "Rusbehandling, Færingen",
                                   emp11_department == 74 ~ "Rusbehandling, ReStart",
                                   emp11_department == 75 ~ "Senter for psykisk helse og rusbehandling Tromsø og omegn, døgnseksjon",
         ...
         tilsett = dplyr::case_when(mce_supervision == 1 ~ "Ja", 
                             ...
                             mce_supervision == 4 ~ "Nei - ikke prioritert, men gitt råd",
                             mce_supervision == 5 ~ "Nei - Annen årsak", 
