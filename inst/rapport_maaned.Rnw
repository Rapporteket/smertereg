...
<<label = datadump, echo = TRUE, include = FALSE>>=

# fixme?
library(magrittr)
library(dplyr)

# if at Rapporteket do not use local files
context <- Sys.getenv("R_RAP_INSTANCE")

if (context == "TEST" | context == "QA" | context == "PRODUCTION") {
  kb <- les_oqr_kb(system.file("SmerteReg_klokeboken.05.10.2017.csv", package = "smertereg"))
  # value of uc param 'flervalgsliste' provide avdresh_vector
  d_full <- smerteGetRegDataFromRapporteketDb(flervalgsliste)
  # at Rapporteket figs must be placed "flat", i.e. no subdir
  ...
  #adresse = paste0(mappe, "datadumper\\prod\\Lokale data\\Datadump Alle Variable Numerisk\\")
  
  ddmappe = list.dirs(adresse) %>% sort %>% last
  
  # Les inn kodebok
  kodebok_filnamn = "SmerteReg_klokeboken.05.10.2017.csv"
  # kb = les_oqr_kb(paste0(mappe, "kodebok\\", kodebok_filnamn))
  # Ta inn kodeboken
  kb = les_oqr_kb(kodebok_filnavn)
...
d_full = d_full %>% 
  dplyr::mutate(pasientid = oqr_pasientid,
         forlopsid = oqr_forlopsid)

# årets år
#aar = lubridate::year(Sys.Date())
aar = 2018 #new, just for now

d_full = d_full %>% dplyr::filter(lubridate::year(mce_registered_date) == aar)

# Legg inn navn på avdelinger

d_full = d_full %>% mutate(avdeling_navn = case_when(emp11_department == 4 ~ "Medisinsk p1 Nord",
                                                     emp11_department == 5 ~ "Medisinsk\navd.1 Vest",
                                                           emp11_department == 6 ~ "Barneklinikken p4",
                                                           emp11_department == 7 ~ "Barneklinikken p5",
                                                           emp11_department == 8 ~ "Hjerte p3 MIO",
                                                           emp11_department == 156 ~ "Hjerte p3 MIO", 
                                                           emp11_department == 9 ~ "Hjerte p4", 
                                                           emp11_department == 10 ~ "Hjerte p1",
                                                           emp11_department == 11 ~ "Hjert p2",
                                                           emp11_department == 12 ~ "Hud sengepost",  
                                                           emp11_department == 13 ~ "Bryst- og\nendokrin (KIR 2)",
                                                           emp11_department == 14 ~ "Gastro og\nakutt p1",
                                                           emp11_department == 15 ~ "Gastro og\nakutt p3", 
                                                           emp11_department == 16 ~ "Karkirurgi", 
                                                           emp11_department == 17 ~ "Plastikkirurgi",
                                                           emp11_department == 18 ~ "Plastikkirurgi og BSA",
                                                           emp11_department == 19 ~ "Urologi (KIR 2)",  
                                                           emp11_department == 20 ~ "Oere, nese, hals",
                                                           emp11_department == 21 ~ "Lunge p3",
                                                           emp11_department == 22 ~ "Lunge p1", 
                                                           emp11_department == 23 ~ "Korttidspost\nmottak",
                                                           emp11_department == 24 ~ "Nevrokirurgisk\nsengep",
                                                           emp11_department == 25 ~ "Nevro akutt", 
                                                           emp11_department == 26 ~ "Nevrologisk p4\nSpinal", 
                                                           emp11_department == 27 ~ "Nevro akutt",
                                                           emp11_department == 28 ~"OT Rehab sengepost",
                                                           emp11_department == 29 ~ "OT p1",  
                                                           emp11_department == 30 ~ "OT p2 vest",
                                                           emp11_department == 31 ~ "OT p2 syd",
                                                           emp11_department == 32 ~ "Medisinsk p6", 
                                                           emp11_department == 33 ~ "Medisinsk p5 vest",  
                                                           emp11_department == 34 ~ "Medisinsk p5 nord",
                                                           emp11_department == 35 ~ "Intensivmedisinsk",
                                                           emp11_department == 154 ~ "Intensivmedisinsk",
                                                           emp11_department == 36 ~ "KK Gyn 1", 
                                                           emp11_department == 37 ~ "KK Gyn 2",
                                                           emp11_department == 38 ~ "Medisinsk\navd.2 Dialyse",
                                                           emp11_department == 39 ~ "Reuma sengepost", 
                                                           emp11_department == 41 ~ "OT barn",
                                                           emp11_department == 42 ~ "Gastro Barn",
                                                           emp11_department == 43 ~ "OENH barnekirurgen p1",  
                                                           emp11_department == 44 ~ "AFMR p2",
                                                           emp11_department == 77 ~ "Medisinsk avd.8",
                                                           emp11_department == 85 ~ "Oeyeavdeling", 
                                                           emp11_department == 40 ~ "Oeyeavdeling",
                                                           emp11_department == 86 ~"Utgreiingsmottak 1",
                                                           emp11_department == 87 ~ "Utgreiingsmottak 2", 
                                                           emp11_department == 152 ~ "Barne- og Ungdomsklinikken p4",
                                                           emp11_department == 153 ~ "Barne- og Ungdomsklinikken p3",
                                                           emp11_department == 157 ~ "Kreft post 2",
                                                           emp11_department == 155 ~ "KSK Postoperativ",
                                                           emp11_department == 158 ~ "Kreft post 1",
                                                           emp11_department == 159 ~ "Akuttmottak",
                                                           emp11_department == 163 ~ "OT infeksjon",
                                                           emp11_department == 164 ~ "Nevro akutt",
                                                     #Her slutter Helse Bergen
                                                           emp11_department == 90 ~ "Barn 1 medisin sengepost",       #Her begynner St.Olav
                                                           emp11_department == 91 ~ "Barn 2 kirurgi sengepost", 
                                                           emp11_department == 92 ~ "Barn 3 infeksjon sengepost",
                                                           emp11_department == 93 ~ "Barn 4 kreft-og blodsykdommer",
                                                           emp11_department == 94 ~ "Barn 5 ortopedi sengepost",
                                                           emp11_department == 95 ~ "Barsel vest",
                                                           emp11_department == 96 ~ "Barsel Oest",
                                                           emp11_department == 97 ~ "Generell gynekologi",
                                                           emp11_department == 98 ~ "Gynekologi kreft sengepost",
                                                           emp11_department == 99 ~ "Kvinneklinikken overvaaking",
                                                           emp11_department == 100 ~ "Kirurgi bryst-endo 5 et tun 1",
                                                           emp11_department == 101 ~ "Elektiv ortopedi sengepost",
                                                           emp11_department == 102 ~ "Plastikkirurgisk sengepost",
                                                           emp11_department == 103 ~ "Revmatologisk sengepost",
                                                           emp11_department == 104 ~ "Kirurgi kar 5. et tun 1-2",
                                                           emp11_department == 105 ~ "Kirurgi Gastro 4 et tun 3-4",
                                                           emp11_department == 106 ~ "Kirurgi Gastro 5 et tun 3-5",
                                                           emp11_department == 107 ~ "Kirurgisk tung overvaaking",
                                                           emp11_department == 108 ~ "Kirurgi urologi sengepost",
                                                           emp11_department == 109 ~ "Kreft dagenhet et M2",
                                                           emp11_department == 110 ~ "Kreft sengepost etg M3",
                                                           emp11_department == 111 ~ "Kreft sengepost lindrende behandling",
                                                           emp11_department == 112 ~ "Sengepost blodsykdommer",
                                                           emp11_department == 113 ~ "Sengepost fordoyelse- og leversykdommer",
                                                           emp11_department == 114 ~ "Sengepost nyresykdommer og endokrinologi",
                                                           emp11_department == 115 ~ "Mottaksavdeling observasjonspost 1",
                                                           emp11_department == 116 ~ "Mottaksavdeling observasjonspost 2",
                                                           emp11_department == 117 ~ "Mottaksavdeling sengepost",
                                                           emp11_department == 118 ~ "Hovedintensiv",
                                                           emp11_department == 119 ~ "Hjertemedisin intensiv 4. et.",
                                                           emp11_department == 120 ~ "Lungemedisin 5. et. tun 3 dagenhet",
                                                           emp11_department == 121 ~ "Lungemedisin 6. et. tun 4-5",
                                                           emp11_department == 122 ~ "Lungemedisin 6. et. tun 2-3",
                                                           emp11_department == 123 ~"Lungemedisin 6. et. tun 1",
                                                           emp11_department == 124 ~ "Lungemedisin 6. et. overvaaking",
                                                           emp11_department == 125 ~ "Thoraxkirurgi intensiv",
                                                           emp11_department == 126 ~ "Thoraxkirurgi sengetun",
                                                           emp11_department == 127 ~ "Sengepost hjerneslag",
                                                           emp11_department == 128 ~ "Avd for ryggmargsskader sengepost",
                                                           emp11_department == 129 ~ "Sengepost geriatri",
                                                           emp11_department == 130 ~ "Kjeve- og ansiktskirurgi sengepost",
                                                           emp11_department == 131 ~ "OENH sengepost",
                                                           emp11_department == 132 ~ "Oeye sengepost",                                     
                                                           emp11_department == 133 ~ "Nevrologisk sengepost",
                                                           emp11_department == 134 ~ "Nevrokirurgisk sengepost",
                                                           emp11_department == 135 ~ "Nevroklinikkens overvaaking",
                                                           emp11_department == 136 ~ "Sengepost infeksjonssykdommer",
                                                           emp11_department == 137 ~ "Hudavdelingens sengepost",
                                                           emp11_department == 138 ~ "Klinikk for rus og avhengighetsmedisin",
                                                           emp11_department == 143 ~ "Ortopedisk avdelinge-ortopedisk traumatologi",
                                                           emp11_department == 144 ~ "Rekonstruktiv ortopedi sengetun",
                                                           emp11_department == 145 ~ "Ortopedisk postoperativ overvaaking",
                                                           emp11_department == 146 ~ "Hjertemedisin tun 3, 4. et.",
                                                           emp11_department == 147 ~ "Hjertemedisin tun 4-5, 4. et. Sør",
                                                           emp11_department == 148 ~ "Hjertemedisin tun 6-7, 4. et. Midt",
                                                           emp11_department == 149 ~ "Hjertemedisin tun 4-5, 5. et. Sør",
                                                           emp11_department == 150 ~ "Avdeling Oestmarka",
                                                           emp11_department == 151 ~ "Avdeling Broeset",                #Her slutter St. Olavs
                                                           emp11_department == 45 ~ "Akuttmottak- og obspostavdeling", #Her begynner UNN
                                                           emp11_department == 46 ~ "Barne- og ungdomsavdeling",
                                                           emp11_department == 47 ~ "Barnehabilitering Tromsoe?",
                                                           emp11_department == 48 ~ "Barne- og ungdomspsykiatrisk avdeling",
                                                           emp11_department == 49 ~ "Hjerte- /Lunge- og karkirurgisk avdeling",
                                                           emp11_department == 50 ~ "Hjertemedisinsk avdeling",
                                                           emp11_department == 51 ~ "Lungemedisinsk avdeling",
                                                           emp11_department == 52 ~ "Avdeling for gastroenterologisk kirurgi",
                                                           emp11_department == 53 ~ "Avdeling for urologi, endokrin og brystkirurgi",
                                                           emp11_department == 54 ~ "Kreftavdelingen",
                                                           emp11_department == 55 ~ "Kvinneklinikken",
                                                           emp11_department == 56 ~ "Gastro- og nyremedisinsk avdeling",
                                                           emp11_department == 57 ~ "Sengepost for blod- og hormonsykdommer",
                                                           emp11_department == 58 ~ "Sengepost for geriatri",
                                                           emp11_department == 59 ~ "Sengepost for infeksjonssykdommer",
                                                           emp11_department == 60 ~ "Nevro-, hud- og revmatologisk avdeling",
                                                           emp11_department == 61 ~ "Nevrokirurgi-, OENH- og Oyeavdeling",
                                                           emp11_department == 62 ~ "Ortopedi- og plastikkirurgisk avdeling",
                                                           emp11_department == 63 ~ "Fysikalsk- og rehabiliteringsmedisin, Tromsoe?/Narvik",
                                                           emp11_department == 64 ~ "Habiliteringsenhet Tromsoe?",
                                                           emp11_department == 65 ~ "Intensiv Tromsoe?",
                                                           emp11_department == 66 ~ "Oppvaakning Tromsoe?",
                                                           emp11_department == 67 ~ "Psykiatri og rusbehandling, LARiNord",
                                                           emp11_department == 68 ~ "Akuttpsykiatrisk seksjon",
                                                           emp11_department == 69 ~ "Alderspsykiatrisk seksjon",
                                                           emp11_department == 70 ~ "Psykose og rusenheten",
                                                           emp11_department == 71 ~ "RUS-Tverrf.Spes. Beh. av rusmiddelmisbruk",
                                                           emp11_department == 72 ~ "Sikkerhetspsykiatrisk seksjon",
                                                           emp11_department == 73 ~ "Rusbehandling, Faeringen",
                                                           emp11_department == 74 ~ "Rusbehandling, ReStart",
                                                           emp11_department == 75 ~ "Senter for psykisk helse og rusbehandling Tromsoe? og omegn, døgnseksjon",
                                                           emp11_department == 76 ~ "Psykiatri og rusbehandling, avrusning og utredning", 
                                                           FALSE ~ "Ikke angitt"),
                                 tilsett = case_when(mce_supervision == 1 ~ "Ja", 
                                                     mce_supervision == 2 ~ "Nei - ikke behov", 
                                                     mce_supervision == 3 ~ "Nei - ikke kapasitet", 
                                                     mce_supervision == 4 ~ "Nei - ikke prioritert, men gitt raad",
                                                     mce_supervision == 5 ~ "Nei - Annen aarsak", 
                                                     is.na(mce_supervision) ~ "Mangler verdi",
                                                     FALSE ~ "Ikke angitt"))
...
tilsyn_full = d_full %>% dplyr::select(pasientid, forlopsid, emp22_caregiver_doctor_times, emp22_caregiver_psychologist_times, 
  ...
  tidyr::gather(key = tilsynstype, value=antall, 
  ...
  dplyr::mutate(antall = replace(antall, is.na(antall), 0), 
         month = lubridate::month(mce_registered_date),
         
         tilsynstype=stringr::str_replace_all(tilsynstype,"emp22_caregiver_doctor_times", 
                                     "Lege"),
         tilsynstype=stringr::str_replace_all(tilsynstype, "emp22_caregiver_nurse_times",
                                     "Sykepleier"), 
         tilsynstype=stringr::str_replace_all(tilsynstype, "emp22_caregiver_physiotherapist_times", 
                                     "Fysioterapeut"),
         tilsynstype=stringr::str_replace_all(tilsynstype, "emp22_caregiver_psychologist_times", 
                                     "Psykolog"),
         tilsynstype=stringr::str_replace_all(tilsynstype, "emp22_caregiver_social_worker_times", 
                                     "Sosionom"),
         tilsynstype=stringr::str_replace_all(tilsynstype, "emp22_consultations", 
                                     "Total"),
         yearmonth = zoo::as.yearmon(mce_registered_date))


# Lage månedsnavn i rekkefølge slik som de er i året

#manednamn = months(as.Date(paste0("2019-",1:12,"-01")))
manednamn = months(as.Date(paste0("2018-",1:12,"-01"))) #new, just for now

tilsyn_full = tilsyn_full %>% dplyr::mutate(monthname = factor(months(mce_registered_date), levels = manednamn)) 

# Filtrer på de som har fått tilsyn

tilsyn = tilsyn_full %>% dplyr::filter(mce_supervision == 1)
...
tilsyn_avdeling = tilsyn %>% dplyr::group_by(tilsynstype, emp11_department, avdeling_navn)  %>% dplyr::count(antall) %>% dplyr::ungroup() %>% 
  dplyr::mutate(emp11_department=forcats::fct_reorder(factor(emp11_department), -n, sum))
...
tilsyn_maned = tilsyn %>% dplyr::group_by(tilsynstype, month, monthname)  %>% dplyr::count(antall) %>% dplyr::arrange(month)

#Totalt Antall tilsyn for pasienter som kom in in viss måned per avdeling

tilsyn_maned_avdeling = tilsyn %>% dplyr::group_by(tilsynstype, monthname, emp11_department)  %>% dplyr::count(antall) 
...
plot_tilsyn_maned = function(d, maaned, type_tilsyn, xlabtekst){
  ...
  if (type_tilsyn == "Alle") {
    d = d %>% dplyr::filter(tilsynstype != "Total", antall != 0)
  } else {
    d = d %>% dplyr::filter(tilsynstype==type_tilsyn) 
  }
  
  if (type_tilsyn == "Fysioterapeut" | type_tilsyn == "Psykolog" | type_tilsyn == "Sosionom" | type_tilsyn == "Total") {
    d = d %>% dplyr::filter(antall != 0)
  } else {
    d = d 
  }
  
  
  graf0 = ggplot2::ggplot(d, aes(x = antall, y =  n, fill=monthname)) + 
  ...
  if(maaned == "Alle"){ 
    ...
    graf0 + ggplot2::facet_wrap(~monthname, ncol = 4)
  }
  
  else{
    
    
    d_maned = d %>% dplyr::filter(monthname == maaned)
    graf0 %+% d_maned
...
plot_tilsyn_avdeling = function(d, type_tilsyn, avdeling, xlabtekst){
  ...
  avdeling_hypp = d %>% 
    dplyr::group_by(emp11_department, avdeling_navn) %>% 
  ...
  d = d %>% dplyr::mutate(avdeling_navn=factor(avdeling_navn, levels=avdeling_hypp))
  
  # For å fjerne avdelinger som har veldig få tilsyn
  d = d %>% 
    dplyr::group_by(avdeling_navn) %>% 
    dplyr::mutate(maksn = max(n)) %>%
    dplyr::filter(maksn>5) %>%
    dplyr::ungroup()
  ...
  if(avdeling == "Alle"){ 
    ...
    d_avdeling = d %>% dplyr::filter(avdeling_navn == avdeling)
    graf0 %+% d_avdeling
...
NB! Denne informasjonen MÅ være med i rapporten (justeres etter ønske):
data er hentet fra innleggelse ved følgende avdelinger:
\Sexpr{paste(unique(d_full$avdeling_navn), collapse = ', ')}.
...
# Regne ut antall tilsyn per måned, samt antall behandlertilsyn (summen av alle de andre typene tilsyn)
arsak_tilsett = d_full %>%  dplyr::count(tilsett) %>% dplyr::mutate(pro = round(100*(n/sum(n))))

antall_svar = arsak_tilsett %>% dplyr::summarise(sum(n))
antall_pas = arsak_tilsett %>% dplyr::count(n)

knitr::kable(arsak_tilsett, caption = paste0("Antall besvarelser om tilsyn for hver kategori. 
                                                   Basert på ",antall_svar," svar fra ",nrow(tilsyn_full %>% dplyr::filter(tilsynstype != "Total") %>% dplyr::distinct(pasientid, .keep_all = TRUE))," pasienter."), col.names = c("Har pasienten fått tilsyn?", "Antall besvarelser", "Prosent besvarelser"), longtable = T)
...
tot_antall =  tilsyn %>% dplyr::filter(tilsynstype == "Total") %>% 
  dplyr::summarise(sum = sum(antall)) # Æsj, summarize funker ikke. Diskriminering!

lege_antall = tilsyn %>% dplyr::filter(tilsynstype == "Lege") %>% dplyr::summarise(sum = sum(antall))

syk_antall = tilsyn %>% dplyr::filter(tilsynstype == "Sykepleier") %>% dplyr::summarise(sum = sum(antall)) 

fys_antall = tilsyn %>% dplyr::filter(tilsynstype == "Fysioterapeut") %>% dplyr::summarise(sum = sum(antall)) 

sos_antall = tilsyn %>% dplyr::filter(tilsynstype == "Sosionom") %>% dplyr::summarise(sum = sum(antall)) 

psyk_antall = tilsyn %>% dplyr::filter(tilsynstype == "Psykolog") %>% dplyr::summarise(sum = sum(antall)) 

sum_typer_antall = tilsyn %>% dplyr::filter(tilsynstype != "Total") %>% dplyr::summarise(sum = sum(antall))
...
sum_tilsyn_maned = tilsyn %>% 
  ...
  dplyr::summarise(antall = sum(antall)) %>% 
  tidyr::spread(tilsynstype, antall) %>% dplyr::rowwise() %>% 
  dplyr::mutate(behandlertilsyn = sum(Fysioterapeut, Lege, Psykolog, Sosionom, Sykepleier))

antall_pas_maned = tilsyn %>% dplyr::distinct(pasientid, .keep_all = TRUE) %>% dplyr::count(monthname) 
antall_henv_maned = tilsyn_full %>% dplyr::distinct(forlopsid, .keep_all = TRUE) %>% dplyr::count(monthname) 

sum_tilsyn_maned = dplyr::bind_cols(sum_tilsyn_maned, antall_pas_maned[ ,2], antall_henv_maned[ ,2])

# Finne summen av hver tilsynstype
total_tilsyn_maned = dplyr::summarise_all(sum_tilsyn_maned[,-1], dplyr::funs(sum))

sum_tilsyn_maned = dplyr::bind_rows(sum_tilsyn_maned, total_tilsyn_maned)
...
knitr::kable(sum_tilsyn_maned, caption = paste0("Antall tilsyn per måned hos 
                       ",nrow(tilsyn %>% dplyr::filter(tilsynstype != "Total") %>% dplyr::distinct(pasientid, .keep_all = TRUE))," pasienter. 
                      ...
                      kan ha vært tilstede samtidig)."), col.names = c("Måned", "Fysioterapeut", "Lege", 
                                                                       ...
                                                                       "Behandlertilsyn", "Pasienttilsyn", "Antall pasienter", "Antall henvisninger")) %>%
...
linje_tilsyn_per_maaned = function(d, type_tilsyn, ylabtekst){
  ...
  d = d %>% dplyr::mutate(yearmonth_date = zoo::as.Date(yearmonth), yearmonth = as.character(yearmonth))
  ...
  if(type_tilsyn == "Alle"){
    ...
    d_tilsyn = d %>% dplyr::filter(tilsynstype == type_tilsyn)
...
alle_maaned_linje=paste0("Antall tilsyn per måned for alle ulike behandlere (inkludert konfidensintervall). Behandlertilsyn er
                               ...
                               hos ",nrow(tilsyn %>% dplyr::filter(tilsynstype != "Total") %>% dplyr::distinct(pasientid, .keep_all = TRUE))," pasienter.")
...
tilsyn_per_maaned = tilsyn %>% 
  dplyr::group_by(tilsynstype, month, yearmonth) %>% 
  dplyr::summarise(snitt=mean(antall) %>% round(1),
            min=t.test(antall)$conf.int[1] %>% round(1),
            maks=t.test(antall)$conf.int[2] %>% round(1)) %>% dplyr::ungroup()

# lag gjennomsnitt behandlertilsyn per måned
behandlertilsyn = tilsyn %>% dplyr::filter(tilsynstype != "Total") %>% dplyr::group_by(month, yearmonth) %>%   
  dplyr::summarise(snitt=mean(antall) %>% round(1),
            min=t.test(antall)$conf.int[1] %>% round(1),
            maks=t.test(antall)$conf.int[2] %>% round(1)) %>% dplyr::mutate (tilsynstype = "Behandlertilsyn") %>% dplyr::ungroup()

# Samle de to objektene
tilsyn_per_maaned = dplyr::bind_rows(tilsyn_per_maaned, behandlertilsyn)

# Og av eller annen merkelig grunn endrer yearmon-formatet seg, fiks
tilsyn_per_maaned$yearmonth = zoo::as.yearmon(tilsyn_per_maaned$yearmonth)

# Lage samme rekkefølge på "Alle" graf som alle andre grafer ellers i dokumentet.

tilsyn_per_maaned = tilsyn_per_maaned %>% dplyr::mutate(tilsynstype =
                                                   factor(tilsynstype, 
...
linje_tilsyn_per_maaned(d = tilsyn_per_maaned %>% dplyr::filter(tilsynstype != "Total"), type_tilsyn = "Alle", ylabtekst = "Gjennomsnittlig\nantall tilsyn")
...
lege_maaned_soyle=paste0("Antall legetilsyn per måned. Basert på ",lege_antall$sum," legetilsyn hos 
                               ",nrow(tilsyn %>% dplyr::filter(tilsynstype == "Lege") %>% dplyr::distinct(pasientid, .keep_all = TRUE))," pasienter.")

syk_maaned_soyle=paste0("Antall sykepleiertilsyn per måned. Basert på ",syk_antall$sum," sykepleiertilsyn hos 
                              ",nrow(tilsyn %>% dplyr::filter(tilsynstype == "Sykepleier") %>% dplyr::distinct(pasientid, .keep_all = TRUE))," pasienter.
                              ")

fys_maaned_soyle=paste0("Antall tilsyn fra fysioterapeut per måned. Basert på ",fys_antall$sum," fysioterapeuttilsyn hos 
                              ",nrow(tilsyn %>% dplyr::filter(tilsynstype == "Fysioterapeut") %>% dplyr::distinct(pasientid, .keep_all = TRUE))," pasienter.")

sos_maaned_soyle=paste0("Antall tilsyn fra sosionom per måned. Basert på ",sos_antall$sum," sosionomtilsyn hos 
                              ",nrow(tilsyn %>% dplyr::filter(tilsynstype == "Sosionom") %>% dplyr::distinct(pasientid, .keep_all = TRUE))," pasienter.")

psyk_maaned_soyle=paste0("Antall tilsyn fra psykolog per måned. Basert på 
                               ",psyk_antall$sum," psykologtilsyn hos 
                               ",nrow(tilsyn %>% dplyr::filter(tilsynstype == "Psykolog") %>% dplyr::distinct(pasientid, .keep_all = TRUE))," pasienter.")
...
tilsyn_maned_uten_total = sum_tilsyn_maned %>% dplyr::filter(monthname != "total")
...
sum_tilsyn_avdeling = tilsyn %>% 
  dplyr::group_by(tilsynstype, avdeling_navn) %>% 
  dplyr::summarise(antall = sum(antall)) %>% 
  tidyr::spread(tilsynstype, antall) %>% dplyr::rowwise() %>% 
  dplyr::mutate(behandlertilsyn = sum(Fysioterapeut, Lege, Psykolog, Sosionom, Sykepleier))

antall_pas_avdeling = tilsyn %>% dplyr::distinct(forlopsid, .keep_all = TRUE) %>% dplyr::count(avdeling_navn) 

sum_tilsyn_avdeling = dplyr::bind_cols(sum_tilsyn_avdeling, antall_pas_avdeling[,2])

# Finne summen av hver tilsynstype
total_tilsyn_avdeling =  dplyr::summarise_all(sum_tilsyn_avdeling[,-1], dplyr::funs(sum))

sum_tilsyn_avdeling = dplyr::bind_rows(sum_tilsyn_avdeling, total_tilsyn_avdeling)
...
sum_tilsyn_avdeling = sum_tilsyn_avdeling %>% 
  dplyr::mutate(avdeling_navn = stringr::str_replace_all(avdeling_navn, "\n", " "))

knitr::kable(sum_tilsyn_avdeling, caption = paste0("Antall tilsyn per avdeling hos 
                                                         ",nrow(tilsyn %>% dplyr::filter(tilsynstype != "Total") %>% dplyr::distinct(pasientid, .keep_all = TRUE))," 
...
tilsyn_avdeling_uten_total = sum_tilsyn_avdeling %>% dplyr::filter(avdeling_navn != "Total")

# Lage rekkefølge fra største til minste avdeling

avdelingnamn = tilsyn_avdeling_uten_total %>% dplyr::arrange(desc(behandlertilsyn)) %>%  extract2("avdeling_navn")

tilsyn_avdeling_uten_total = tilsyn_avdeling_uten_total %>% dplyr::mutate(avdelingsnavn = factor(avdeling_navn, levels = avdelingnamn)) 
...
plot_sum_tilsyn_avdeling = function(d, tilsynstype, ylabtekst){
  ...
  avdelingnamn = d %>% dplyr::arrange(desc(tilsynstype)) %>%
    extract2("avdeling_navn")
  
  d = d %>% 
    dplyr::mutate(avdelingsnavn = factor(avdeling_navn, levels = avdelingnamn)) 
