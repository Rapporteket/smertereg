...
d_full = d_full %>% mutate(avdeling_navn = case_when(emp11_department == 4 ~ "Medisinsk p1 Nord",
                                                     ...
                                                     #Her slutter Helse Bergen
                                                           ...
                                                           emp11_department == 147 ~ "Hjertemedisin tun 4-5, 4. et. SÃ¸r",
                                                           emp11_department == 148 ~ "Hjertemedisin tun 6-7, 4. et. Midt",
                                                           emp11_department == 149 ~ "Hjertemedisin tun 4-5, 5. et. SÃ¸r",
                                                           ...
                                                           emp11_department == 75 ~ "Senter for psykisk helse og rusbehandling Tromsoe¸ og omegn, dÃ¸gnseksjon",
