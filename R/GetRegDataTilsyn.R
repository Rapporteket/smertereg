#' Query registry data from smerte db for tilsyn
#'
#' @param reshID string providing dept key
#' @return a data frame with registry data
#' @export

getRegDataTilsyn <- function(reshID) {
...
"
  ...
  query <- paste(query, "WHERE AvdRESH IN (", reshID, ")")
